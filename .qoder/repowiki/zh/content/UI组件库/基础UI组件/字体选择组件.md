...
## 更新摘要
**变更内容**
- 更新长图文模式的字体处理机制，从可选字体改为固定黑体系统字体栈
- 新增长图文模式字体固定化的架构说明
- 更新相关组件的集成方式和使用场景
...
**重要更新**：长图文模式现已固定使用黑体系统字体栈，不再提供字体选择功能，以确保在微信公众号等平台复制粘贴时的字体一致性。
...
- [ArticlePreview.tsx:10-11](file://src/modes/article/ArticlePreview.tsx#L10-L11)
- [store.ts:80-81](file://src/lib/store.ts#L80-L81)
...
- [ArticlePreview.tsx:1-154](file://src/modes/article/ArticlePreview.tsx#L1-L154)
- [store.ts:1-299](file://src/lib/store.ts#L1-L299)
...
- [store.ts:106-107](file://src/lib/store.ts#L106-L107)
...
**重要更新**：长图文模式(ArticleMode)中的 ArticlePreview 组件固定使用黑体系统字体栈，不再提供字体选择功能。
...
**新增功能**：长图文模式(ArticleMode)现已固定使用黑体系统字体栈，确保在微信公众号等平台复制粘贴时的字体一致性。

**实现细节：**
- ArticlePreview 组件中明确注释说明固定使用黑体系统字体栈
- 固定字体确保跨平台兼容性和复制粘贴的一致性
- 移除了长图文模式中的 FontSelect 组件

**章节来源**
- [ArticlePreview.tsx:10-11](file://src/modes/article/ArticlePreview.tsx#L10-L11)
- [ArticlePreview.tsx:142](file://src/modes/article/ArticlePreview.tsx#L142)
...
ARTICLEPREVIEW --> FONTS
DOCMODE --> STORE
CARDMODE --> STORE
ARTICLEPREVIEW --> STORE
DOCMODE --> CSS
CARDMODE --> CSS
REACT --> FS
TYPESCRIPT --> FS
...
- [fonts.ts:1-16](file://src/lib/fonts.ts#L1-L16)
- [ArticlePreview.tsx:8](file://src/modes/article/ArticlePreview.tsx#L8)
- [store.ts:80-81](file://src/lib/store.ts#L80-L81)
...
**问题4：长图文模式字体不一致**
- 确认 ArticlePreview 使用的是固定黑体系统字体栈
- 检查复制粘贴到目标平台时的字体处理
- 验证目标平台对系统字体的支持情况
...
4. **用户体验**：直观的界面和流畅的交互
5. **性能优化**：合理的渲染策略和资源管理
6. **平台适配**：针对不同平台的字体策略优化

**重要更新**：长图文模式的字体固定化策略确保了跨平台的一致性，特别是在微信公众号等平台的复制粘贴场景中，为用户提供了更好的使用体验。
